...
<body class="landing-page">
    <header class="bg-white px-4 sm:px-6 py-5 shadow fixed top-0 w-full z-50" x-data="{ open:false }">
        <div class="max-w-7xl mx-auto flex items-center">  
            ...
            <!-- TENGAH: Nav desktop -->
            <nav class="flex-1 hidden md:flex justify-center gap-6 text-sm sm:text-base font-medium text-[#667085]">
                <a href="#internship" class="flex items-center gap-1 hover:text-black">
                    Internship
                    <img src="{{ asset('images/arrow_down.svg') }}" alt="arrow" class="w-3 h-3 opacity-70 group-hover:opacity-100 transition duration-200">
                </a>
    ...
    <section id="internship" class="relative w-full h-[600px] pt-80px flex items-center text-white overflow-hidden">
        <img src="{{ asset('images/infomagang.png') }}" class="absolute inset-0 w-full h-full object-cover z-10" alt="info">
        <div class="absolute inset-0 bg-black opacity-40 z-10"></div> <!-- overlay --> 
        <div class="relative z-20 max-w-3xl mx-auto px-6 text-left">
            <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-white">Kickstart Your Career with an Internship at Witel Yogya Jateng Selatan!</h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 items-center gap-10">
            ...
            <div>
                ...
                <div class="duration-700 ease-in-out" data-carousel-item="active">
                    <img src="{{ asset('images/benefitcr1.png') }}" alt="Benefit 1" class="object-cover w-full h-full rounded-lg">
                </div>

                <!-- Carousel Item 2 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="{{ asset('images/benefitcr2.png') }}" alt="Benefit 2" class="object-cover w-full h-full rounded-lg">
                </div>

                <!-- Carousel Item 3 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="{{ asset('images/benefitcr3.png') }}" alt="Benefit 3" class="object-cover w-full h-full rounded-lg">
                </div>

                <!-- Carousel Item 4 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="{{ asset('images/benefitcr4.png') }}" alt="Benefit 4" class="object-cover w-full h-full rounded-lg">
                </div>
                ...
                <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse">
                    <button type="button" class="w-3 h-3 rounded-full bg-white/70" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="0"></button>
                    ...
                    <button type="button" class="w-3 h-3 rounded-full bg-white/50" aria-label="Slide 4" data-carousel-slide-to="3"></button>
                </div>
            ...
            <p class="text-gray-600 text-base sm:text-lg leading-relaxed">
                Program Magang dan Kerja Praktik Witel Yogya Jateng Selatan mengundang para mahasiswa untuk terlibat langsung dalam proyek-proyek industri, mengembangkan keterampilan digital, serta merasakan secara langsung budaya kerja yang kolaboratif.
            </p>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="flex flex-wrap sm:flex-nowrap justify-center sm:justify-between gap-4 sm:gap-6">
                @foreach([
                    ['img' => 'benefit 1.png', 'title' => 'Eksplorasi pengetahuan dan kemampuan secara langsung', 'desc' => 'Bangun relasi dan jaringan yang luas tidak hanya dengan teman satu program studi atau universitas, tetapi juga dengan peserta dari berbagai latar belakang dan profesional di industri.'],
                    ['img' => 'benefit 2.png', 'title' => 'Perluas koneksi profesional', 'desc' => 'Dapatkan pengalaman praktis dengan terlibat langsung dalam berbagai tantangan dan proyek di lapangan, sekaligus mengasah keterampilan yang relevan dengan kebutuhan industri.'],
                    ['img' => 'benefit 3.png', 'title' => 'Belajar langsung dari para ahli dan mitra terpercaya', 'desc' => 'Dapatkan bimbingan dan wawasan eksklusif dari mitra industri Telkom Witel Yogya Jateng Selatan yang berpengalaman, profesional, dan diakui secara nasional maupun internasional.'],
                ] as $benefit)
                    <div class="bg-[#f1f1f1] rounded-xl p-4 sm:p-6 text-center shadow-sm hover:-translate-y-2 transition w-[30%] min-w-[100px] sm:w-full">
                        <img src="{{ asset('images/' . $benefit['img']) }}" alt="benefit image" class="mb-2 sm:mb-4 mx-auto w-10 sm:w-12">
    ...
    <section class="bg-gradient-to-r from-[#ED1E28] to-[#9c0b1a] text-white py-20 rounded-3xl mx-4 sm:mx-6 lg:mx-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="text-center mb-12 text-white">
                ...
                <p class="text-sm sm:text-base mt-3 text-gray-100">Program magang kami telah mendukung ribuan peserta di seluruh Indonesia</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-center">
                ...
                <div class="flex flex-col items-center">
                    <img src="{{ asset('images/pendaftar.svg') }}" alt="pendaftar" class="w-10 h-10 mb-3 filter invert brightness-0">
                ...
                <div class="flex flex-col items-center">
                    <img src="{{ asset('images/lamar.svg') }}" alt="pendaftar" class="w-10 h-10 mb-3 filter invert brightness-0">
                ...
                <div class="flex flex-col items-center">
                    <img src="{{ asset('images/role.svg') }}" alt="pendaftar" class="w-10 h-10 mb-3 filter invert brightness-0">
                ...
                <div class="flex flex-col items-center">
                    <img src="{{ asset('images/partnership.svg') }}" alt="pendaftar" class="w-10 h-10 mb-3 filter invert brightness-0">
    ...
    @php
        ...
        [
            ...
            'quote' => 'Pengalaman magang di Telkom Witel YJS sangat menyenangkan. Banyak belajar hal-hal baru terutama culture dari bagaimana telkom witel yogya jateng selatan bekerja.'
        ],
        [
        ...
        [
            ...
            'quote' => 'Magang di telkom witel yogya jateng selatan kita bisa belajar banyak hal baru'
        ],
        [
            'name' => 'Bintang Ari Suwardi',
            'instansi' => 'Universitas Atma Jaya Yogyakarta',
            'image' => asset('images/profil4.jpeg'),
            'quote' => 'Selama magang di Telkom saya mendapatkan pengalaman dan pengetahuan penting yang dapat membantu saya menjadi individu yang lebih baik lagi'
        ],
        [
            'name' => 'Nafisko Jaswayoga Prana',
            'instansi' => 'Universitas Negeri Yogyakarta',
            'image' => asset('images/profil5.jpeg'),
            'quote' => 'Selama magang di Divisi Human Capital Telkom Witel Yogya Jateng Selatan, saya mendapatkan banyak pengalaman berharga, 
                        mulai dari membantu proses rekrutmen, mengelola data karyawan hingga terlibat dalam kegiatan pelatihan dan pengembangan. 
                        Saya belajar langsung bagaimana pengelolaan SDM dilakukan secara profesional di perusahaan BUMN. Tim yang suportif dan budaya kerja yang positif membuat pengalaman magang ini sangat bermanfaat dan membekas.'
        ],
        [
            'name' => 'Zeda Kamila Akhyarv',
            'instansi' => 'Universitas Ahmad Dahlan',
            'image' => asset('images/profil6.jpeg'),
            'quote' => 'Magang di Telkom Yogyakarta benar-benar membuka mata saya tentang dunia kerja. Jauh dari bayangan menakutkan, lingkungan di sini justru sangat suportif dan penuh inspirasi. 
        ...
        [
            ...
            'quote' => 'Mendapatkan pengetahuan yang dapat membantu mengasah kemampuan, mempelajari problem solving'
        ],
        ];
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 text-center">
            ...
            <div id="testimonialWrapper"
                ...
                <div class="flex-shrink-0 snap-center w-[300px] bg-white rounded-xl shadow-md p-6">
                    ...
                    <p class="text-sm text-gray-500 italic">“{{ \Illuminate\Support\Str::limit($item['quote'], 150, '...') }}”</p>
                </div>
                @endforeach
            </div>
