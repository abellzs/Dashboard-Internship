<div class="p-4 space-y-6">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-6">
        ...
        <!-- Total Peserta Masuk -->
        <div
            class="bg-white shadow-md rounded-xl p-6 transform transition duration-300 hover:scale-105 hover:shadow-lg">
            <div class="flex items-center space-x-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white border border-gray-100 shadow rounded-xl p-5">
            ...
            <div class="flex items-center justify-center" style="height: 340px;">
